	...
	<head>
		...
		<script type="text/javascript">
			...
			function validateuser(){
				if(validateloginname()==true  && validatename()==true
		...
		<div id="two" >
	  	...
	  	<div id="four">
		    ...
		    <div  id = "three" >
		<form action="<%=path%>/UpdateUser" method="get" onsubmit="return validateuser();">
	    <input type='hidden' name='userid' value='${obj.user_id}'>
		<table bgcolor="white">
		    <tr>
				 <td colspan="2"><center><h3>修改信息</h3></center></td>
				</tr>
			<tr>
			<tr>
				<td>用户名：</td>
				<td><input  id='loginname' type="text" size="22" maxlength="20" name="loginname" value='${obj.user_loginname}' >
			...
			<tr>
				<td>姓名：</td>
				<td><input id ='name' type="text" size="22" maxlength="10" name="realname" placeholder="请输入姓名" value='${obj.user_realname}'>
				<span style="color:#F00;">*</span></td>
				<td>用于身份核验，请正确填写</td>
			</tr>
			<tr>
				<td>身份证号：</td>
				<td><input id ='cardnumber' type="text" size="22" name="cardnumber" placeholder="请输入您的证件号码" value='${obj.user_cardnumber}'> 
				<span style="color:#F00;">*</span></td>
				<td>用于身份核验，请正确填写</td>
			</tr>
			<tr>
				<td>电话号码：</td>
				<td><input  id ='phonenumber' type="text" size="22" maxlength="14" name="telephone" placeholder="请输入您的电话号码" value='${obj.user_telephone}'>
				<span style="color:#F00;">*</span></td>
		...
		<tr>
			...
			<tr>
				<td colspan="2">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<%=path%>/QueryUserServlet" >退出</a>
				</td>
			</tr>
		</table>
		</form> 
